...
import { useCampeonatos } from "@/composables/campeonatos/useCampeonatos";
...
<template>
    <Head title="Campeonatos"></Head>
    <Content>
        <template #header>
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="m-0"><i class="fa fa-list"></i> Campeonatos</h3>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-12">
                        <MiTable
                            ...
                            :cols="headers"
                            :api="true"
                            :url="route('campeonatos.paginado')"
                            :numPages="5"
